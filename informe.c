...
//int mail(char *remitent, char *desti, char *cos_email);
    ...
    sprintf(ordre,"SELECT MAX(temps) FROM alarmes");
    sqlite(ordre);
    ...
    sprintf(ordre,"SELECT AVG(temps) FROM alarmes");
    sqlite(ordre);
